...
if (typeof HS_ICON_CLOSED === 'undefined') {
    var HS_ICON_CLOSED = '<i class="fa fa-plus-circle outline-action"></i>';
}
if (typeof HS_ICON_OPEN === 'undefined') {
    var HS_ICON_OPEN = '<i class="fa fa-minus-circle outline-action"></i>';
}
if (typeof HS_ICON_EMPTY === 'undefined') {
    var HS_ICON_EMPTY = '<small>[Add]</small>';
}
    ...
    for (var i = 3; i <= 5; i++) {
        $('#content .outline-' + i).each(function() {
            ...
            if (header.siblings().length > 0) {
                ...
                if (HS_ALWAYS_DISPLAY_ICON == true) {
                  header.append('<span class="ellipsis clear"> '
                                + HS_ICON_EMPTY
                                + '</span>'
                  );
                }
